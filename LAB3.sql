...
LOOP
v_sql := 'Drop table ' || '"' || objects_tab(i).table_name || '"' || '
cascade constraints';
...
v_sql := 'Drop ' || OBJECT_TYPE_IN || ' ' ||
objects_obj(i).object_name ;
EXECUTE immediate v_sql;
END IF;
END LOOP;
END IF;
...
ALTER TABLE "ORDERS_LINE" ADD CONSTRAINT "ORDERS_LINE_PK" PRIMARY KEY
("ORDERS_LINE_ID")
USING INDEX ENABLE;
--------------------------------------------------------
...
ALTER TABLE "PRODUCT_STATUS" ADD CONSTRAINT "PRODUCT_STATUS_PK" PRIMARY KEY
("PRODUCT_STATUS_ID")
USING INDEX ENABLE;
...
--------------------------------------------------------
ALTER TABLE "ORDERS_LINE" ADD CONSTRAINT "ORDERS_LINE_FK1" FOREIGN KEY
("ORDERS_LINE_ORDERS_ID")
REFERENCES "ORDERS" ("ORDERS_ID") ENABLE;
ALTER TABLE "ORDERS_LINE" ADD CONSTRAINT "ORDERS_LINE_FK2" FOREIGN KEY
("ORDERS_LINE_PRODUCT_ID")
REFERENCES "PRODUCT" ("PRODUCT_ID") ENABLE;
--------------------------------------------------------
-- Ref Constraints for Table PRODUCT
--------------------------------------------------------
ALTER TABLE "PRODUCT" ADD CONSTRAINT "PRODUCT_FK1" FOREIGN KEY
...
ENABLE;
ALTER TABLE product_price ADD CONSTRAINT product_price_chk1 CHECK
( product_price_price > 0 ) ENABLE;
BEGIN
PRC_CREATE_TRIGGERS();
END;
/
...
order_state_order_status_id_in order_state.order_state_order_status_id
%TYPE,
...
set_order_status(orders_id_in, v_next_order_status_id,
order_state_eff_date_in);
END IF;
...
vgender_names varray := varray('Male', 'Female', 'Cisgender', 'Transgender',
'Nonbinary');
vstreet_names1 varray := varray('Oak', 'Elm', 'Beaver', 'Quail', 'Red',
'North', 'South', 'East', 'West', 'Green',
'Farrell', 'Pinkerton', 'Derry', 'Vergennes',
'Silver',
'Golden', 'Cavalier', 'Laurel', 'Connecticut',
'Columbia',
'Hilltopper', 'Stirling', 'Silica', 'Norh',
'Yorkchester',
'Ziegler', 'Crutch', 'Phyllis', 'Jaquar',
'Willakenzie',
'Hard', 'Terry', 'Frankfort', 'Fews',
'Arapahoe',
'Morrissey', 'Learning,', 'Monroe', 'Back',
'Cedar',
'Ingram', 'Chestnut', 'Compton', 'Westminster',
'Hennepin',
'Richley', 'Adams', 'Otterburn', 'Maverick',
'Level',
'Pear', 'Rose', 'Medford', 'Summit', 'Swanwick',
'Munchach', 'Miles', 'Plum', 'Misty', 'Ward',
'Goodridge', 'Matthews', 'White', 'Olympian',
'Panorama',
'Law', 'Lindsey', 'Barnes', 'Dunlap', 'Husky',
'Pomona', 'Royal', 'Jacquard', 'Lunaliho',
'Cayuga',
'Sugar', 'Kalanianaole', 'Ray', 'Monmouth',
'Tarrar',
'Pettis', 'All', 'Genoa', 'Oakwood', 'Cabot',
'Basse', 'Southridge', 'Shorehaven', 'Burcham',
'McCrimmon',
'Keaau-Pahoa', 'Legion', 'Santa', 'Olinda',
'Waterhouse',
'Goddard', 'Haygood', 'Maynard', 'East-West',
'Seeger');
vstreet_names2 varray := varray('Ridge', 'Valley', 'Creek', 'Forest', 'Mill',
'Ferry', 'River', 'Mountain', 'Hill', 'Woods',
'Butternut', 'Kennedy', 'Loyalsock', 'Tusculum',
'Via',
'Franconia', 'Fieldston', 'Grand', 'Perimeter',
'Nortus',
'Westheimer', 'Yosemite', 'Slaughter',
'Hillyer', 'Points',
'Hawkins', 'Smoky', 'Stabler', 'Cottonville',
'Lakota',
'London', 'Georgetown', 'Mulberry', 'Avon',
'Grindstone',
'Hornet', 'Jagerson', 'Aviation', 'Lamm',
'Hocking',
'Uvalde', 'Appleyard', 'Nox', 'Bowman',
'Walzem',
'Warrendale', 'Senecca', 'Perryville',
'Galloway', 'Clarke',
'Admore', 'Walker', 'Peace', 'Southwest',
'Gifford',
'Underwood', 'Thorne', 'Stanley', 'Harlin',
'Bryan',
'Ferndale', 'Schubert', 'Lafayette', 'Vista',
'Voices',
'Ohio', 'Shroyer', 'Telegraph', 'Higby',
'Hunsberger',
'Middlebelt', 'Weymouth', 'Mapleton',
'Hollingsworth', 'Copeland',
'Francis', 'Saulino', 'Hawthorne', 'Northeast',
'International',
'Kamehameha', 'Huebner', 'Edgemere', 'Gorsuch',
'Chasepeak',
'Rockfish', 'Riley', 'Elk', 'Ainsworth', 'Silo',
'Aurora', 'Farmdale', 'Monte', 'Porter',
'Horsham',
'Warfath', 'Widefield', 'Hillsmere', 'Crozier',
'Proffett');
vstreet_names3 varray := varray('Street', 'Avenue', 'Court', 'Highway', 'Lane',
'Parkway', 'Circle', 'Road', 'Boulevard',
'Crossing',
'S.W.', 'Rdg.', 'Ne', 'Alley', 'HS',
'S.E.', 'Dr', 'Bldg', 'rrug???¡¯????', 'Section',
'Walk', 'Promenade', 'Northeast', 'Commune',
'Complex',
'Essex', 'Trail', 'Terrace', 'Hwy', 'Route',
'Development', 'Drive', 'Studios', 'Annex',
'Commission',
'Spur', 'Academies', 'Yard', 'Preserve',
'South',
'Ministry', 'Ulica', 'Strada', 'Rue', 'Straat',
'Carrer', 'Calle', 'Gata', 'Ulice',
'Cestn???¡¯????',
...
'smanning.', 'cosima.', 'hendrix.', 'rduncan.',
'magchan.',
'insight.', 'swan.', 'chicken.', 'delphine.',
'monkey.',
...
vemail3 varray := varray('Pacific.com', 'Caribbean.com', 'Indian.net',
'Bering.net', 'Arabian.com',
'Tasman.com', 'Barents.com', 'Antarctic.com',
'Mediterranean.com', 'Atlantic.com',
'countermail.com', 'neomailbox.com', 'runbox.net',
'safemail.net', 'vmail.com',
'mutemail.com', 'crypto.com', 'sestra.com',
'rediff.com', 'zoho.com',
'moonshine.com', 'copperhead.com', 'starfeet.net',
'fonstuff.net', 'reference.com',
'ncs.com', 'hostit.com', 'baggins.com', 'augustus.com',
'zebra.com',
'bluelight.com', 'adelphia.com', 'prodigy.net',
'netzero.net', 'juno.com',
'toucan.com', 'flash.com', 'mindspring.com',
'brutus.com', 'celtic.com',
'starmail.com', 'mailbox.com', 'batbox.net',
'speedymail.net', 'xyzmail.com',
'sunshinel.com', 'heaven.com', 'brosestra.com',
'bluedriff.com', 'whoho.com',
'siu.edu', 'sife.org', 'isdls.org', 'ri.org',
'sprintmail.com',
'gmail.com', 'worldboston.org', 'ihrco.com',
'ajshotels.com', 'hilton.com',
'knology.net', 'theinter.com', 'aloha.com',
'ihclt.org', 'radisson.com',
'phelpsstokes.org', 'jsums.edu', 'adnc.com',
'onondagacoach.com', 'twinlimo.com',
'infionline.net', 'eurocentres.com', 'Grandecom.net',
'understandourworld.org', 'ivcdetroit.org',
'aviahotels.com', 'cdsintl.org', 'quincysuites.com',
'aaionline.org', 'indigoinn.com',
'hitlon.com', 'wyndham.com', 'agreatwaytogo.com',
'northstate.net', 'kdsi.net',
'sheratonkc.com', 'innisfree.com', 'hotmail.com',
'miusa.org', 'aiesecus.org',
'bc.edu', 'irex.org', 'jalc.org', 'usicomos.org',
'bu.edu',
'internationalsport.com', 'kennesaw.edu', 'wtci.org',
'umn.edu', 'yahoo.co.uk');
v_product_name varray := varray('Kia Forte', 'Chery A5', 'Suzuki Celerio',
'Lykan HyperSport', 'Ferrari 488',
'Toyota Land Cruiser Prado', 'Mercedes-Benz SLK-
Class', 'Mercedes-Benz SL-Class (R231)', 'Lexus LFA',
'?...? koda Octavia',
'Honda Brio', 'Ford Taurus (sixth generation)',
'McLaren P1', 'Volkswagen Jetta Pionier', 'Suzuki Lapin',
'Ascari KZ1', 'Mitsubishi Mirage', 'Infiniti M',
'Volvo XC90', 'Honda N-One',
'Opel Adam', 'Lada Riva', '?...? koda Rapid
(2011)', 'Renault Espace', 'Nissan NV (North America)',
'BMW X5', 'BMW 2 Series (F22)', 'Nissan Armada',
'Daihatsu Sigra', 'Nissan Qashqai',
'BMW 5 Series Gran Turismo', 'Hyundai ix20',
'Hyundai Veracruz', 'Opel Mokka', 'Jeep Compass',
'Porsche 991', 'Volkswagen Atlas', 'Volkswagen
Scirocco', 'Daewoo Lacetti', 'Buick Park Avenue',
'Smart Forfour', 'Honda Clarity', 'Lancia
Ypsilon', 'Citro????n C2', 'Bentley Continental Flying Spur (2005)',
'Range Rover Sport', 'Cadillac DTS', 'Alfa Romeo
GT', 'Fiat Grande Punto', 'Toyota Allion',
'Audi Q7', 'Ferrari California', 'Lexus CT',
'Toyota 86', 'BMW M4',
'Honda S660', 'Chevrolet Captiva', 'Peugeot
5008', 'Mercedes-Benz GLA-Class', 'Alfa Romeo Stelvio',
'Renault Clio', 'Mahindra Quanto', 'Renault
Laguna', 'Audi Q3', 'Acura RDX',
'Citro????n C6', 'Infiniti QX80', 'Suzuki
Ignis', 'Pontiac Solstice', 'Honda BR-V',
'BYD e6', 'Tata Indigo', 'Great Wall Voleex
C30', 'Renault Fluence Z.E.', 'Mazdaspeed3',
'SsangYong Musso', 'Toyota Aygo', 'Chevrolet
Cobalt', 'Lada Granta', 'Renault Koleos',
'Volvo S40', 'Mercedes-Maybach 6', 'Tata Aria',
'Cadillac CTS', 'Ford Fusion (Americas)',
'SEAT Altea', 'Vehicle Production Group', 'Lotus
Evora', 'Audi A3', 'Perodua Bezza',
'Saturn Vue', 'Volkswagen Touareg', 'Volkswagen
Jetta', 'Land Rover Discovery Sport', 'Chevrolet Volt (second generation)',
'Ford EcoSport', 'Toyota Belta', 'Jaguar F-
Pace', 'Geely CK', 'Lotus Elise');
v_prsn_name varray := varray('Aaronson', 'Abra', 'Absa', 'Abshier',
'Adaiha',
'Adama', 'Adams', 'Addi', 'Addia', 'Adebayo',
'Adelaida', 'Adey', 'Adriaens', 'Adrian',
'Adrianna',
'Adriene', 'Aguste', 'Aia', 'Airlie', 'Alair',
'Albin', 'Alburga', 'Aldercy', 'Alek',
'Alessandra',
...
'An', 'Ananna', 'Anastase', 'Anastasius',
'Ancelin',
'Andrea', 'Anissa', 'Anjali', 'Anna-Diana',
'Annecorinne',
'Anurag', 'Any', 'Anya', 'Aphra', 'Aprilette',
'Ardeth', 'Areta', 'Arezzini', 'Argile', 'Arissa',
'Armbruster', 'Arni', 'Arratoon', 'Artemus',
'Asare',
...
'Beichner', 'Beilul', 'Belcher', 'Bellda',
'Benzel',
'Bergren', 'Berkow', 'Bertelli', 'Bertilla',
'Beryle',
'Bess', 'Bessy', 'Binah', 'Bing', 'Birecree',
'Birkner', 'Bishop', 'Blinnie', 'Block',
'Blondell',
...
'Buck', 'Buckingham', 'Buehrer', 'Burkhardt',
'Burra',
'Buseck', 'Bushey', 'Button', 'Byrne', 'Bywaters',
'Calabresi', 'Call', 'Camel', 'Camila', 'Campman',
'Caniff', 'Cannell', 'Carder', 'Carita', 'Carry',
'Case', 'Casimir', 'Cassandry', 'Cassy',
'Castillo',
'Castro', 'Catherin', 'Cathrin', 'Chambers',
'Chandler',
'Chappy', 'Charie', 'Charlotte', 'Chellman',
'Cherise',
'Cheshire', 'Chiaki', 'Chisholm', 'Chrisman',
'Christean',
'Christian', 'Christiane', 'Christis', 'Chrotoem',
'Chrystel',
'Ciapas', 'Cicero', 'Cindie', 'Cinnamon', 'Ciro',
'Claiborn', 'Clarisa', 'Clarita', 'Clayborn',
'Clayborne',
'Cleopatra', 'Cocks', 'Cohberg', 'Cohl', 'Cointon',
'Colb', 'Coltun', 'Concha', 'Coniah', 'Conlan',
'Constance', 'Corabel', 'Cordelia', 'Cormick',
'Cornell',
'Cornie', 'Corny', 'Corotto', 'Cosma', 'Craner',
'Crary', 'Creath', 'Crellen', 'Crispin',
'Cristabel',
...
'Delaney', 'Delwin', 'Demetris', 'Demitria',
'Dempsey',
'Denman', 'Deppy', 'Deragon', 'Derk', 'Derna',
'Derwood', 'Desirae', 'Dewain', 'Dewhurst',
'Diantha',
'Dincolo', 'Dionne', 'Dodwell', 'Dogs', 'Dolf',
'Donnenfeld', 'Doscher', 'Dott', 'Dotti',
'Dougherty',
'Doughman', 'Dragelin', 'Drolet', 'Drusus',
'Dukey',
...
'Farlie', 'Fauman', 'Favata', 'Fayina',
'Featherstone',
'Feeley', 'Feingold', 'Fennell', 'Fennessy',
'Fernyak',
'Ferro', 'Fiann', 'Fidelio', 'Fields', 'Fifine',
'Figone', 'Fillander', 'Fleming', 'Fontana',
'Forrest',
'Forsta', 'Francesca', 'Frasch', 'Frasier',
'Fredel',
'French', 'Fronia', 'Fronniah', 'Frost', 'Fryd',
'Furey', 'Gabe', 'Gabi', 'Gaddi', 'Galven',
'Gannie', 'Gapin', 'Gardy', 'Garey', 'Gargan',
'Geer', 'Geibel', 'Geldens', 'Genevieve',
'Genevra',
'Genisia', 'Geno', 'George', 'Georgeanne',
'Geraud',
'Gereld', 'Gerkman', 'Germann', 'Gerome',
'Gerrald',
'Gertrude', 'Gigi', 'Gilchrist', 'Gilmour',
'Ginevra',
'Gittle', 'Giusto', 'Glick', 'Gnni', 'Goddard',
'Golden', 'Goldsmith', 'Goldsworthy', 'Golightly',
'Gollin',
'Goody', 'Goran', 'Gould', 'Graehme', 'Grail',
'Grange', 'Grearson', 'Greenwood', 'Grenville',
'Grissom',
'Grounds', 'Gruber', 'Guevara', 'Guibert', 'Guild',
'Gulgee', 'Gunther', 'Gurevich', 'Gustavus',
'Gustie',
'Gypsy', 'Hachman', 'Haddad', 'Haff', 'Hakan',
'Haleigh', 'Hallett', 'Hallock', 'Hamann', 'Hamid',
'Hamlen', 'Hannibal', 'Hansen', 'Hanzelin',
'Hardin',
'Harley', 'Hartmunn', 'Harwill', 'Haughay',
'Haukom',
'Hecht', 'Hedelman', 'Hedgcock', 'Heidi',
'Heilner',
'Helve', 'Henri', 'Henriha', 'Henryetta',
'Hephzipah',
'Hermina', 'Herodias', 'Herrmann', 'Heti', 'Hett',
'Heyman', 'Hicks', 'Hindorff', 'Hirsh',
'Hitchcock',
'Hitoshi', 'Hluchy', 'Hock', 'Hogan', 'Hoi',
'Holden', 'Hollenbeck', 'Hollister', 'Honniball',
'Hooge',
'Hoopes', 'Horter', 'Horwitz', 'Houghton',
'Hourihan',
...
'Kawai', 'Kellina', 'Kendyl', 'Kentigerma',
'Kenway',
'Kerge', 'Keverian', 'Khichabia', 'Khoury',
'Kikelia',
'Killarney', 'Kimitri', 'Kimmi', 'Kirchner',
'Kirst',
'Kirstyn', 'Kirwin', 'Kleiman', 'Kloster',
'Kneeland',
...
'Lesslie', 'Leverick', 'Levesque', 'Levison',
'Leyla',
'Libna', 'Lilli', 'Lillian', 'Lily', 'Lindeberg',
'Lindholm', 'Lindi', 'Lindsey', 'Ling', 'Link',
'Linkoski', 'Lipfert', 'Lisetta', 'Lisette',
'Lissak',
'Liz', 'Lombard', 'Lopes', 'Lorant', 'Lorenz',
'Losse', 'Lovato', 'Lovell', 'Lovett', 'Lowson',
'Lucius', 'Lunetta', 'Lussier', 'Lyris',
'Lyudmila',
'Macario', 'MacIntosh', 'MacLean', 'Madelyn',
'Madonia',
'Magavern', 'Magda', 'Maison', 'Maje', 'Malamut',
'Mallen', 'Mandal', 'Manlove', 'Manning', 'Margit',
'Margreta', 'Mariande', 'Marie-Jeanne',
'Mariquilla', 'Marissa',
'Marks', 'Marozik', 'Marr', 'Martell', 'Martina',
'Massingill', 'Mastrianni', 'Mathias', 'Mathilda',
'Matilde',
'Maupin', 'Maurreen', 'Mayberry', 'McAllister',
'McDonald',
'McNair', 'Meek', 'Meggs', 'Mehetabel', 'Mel',
'Melan', 'Melisandra', 'Melvyn', 'Menashem',
'Mera',
'Meraree', 'Metzgar', 'Michell', 'Mickey',
'Middendorf',
'Miett', 'Migeon', 'Mikael', 'Milena', 'Milinda',
'Milla', 'Millman', 'Mingche', 'Mireille',
'Mirisola',
...
'Priscilla', 'Prisilla', 'Profant', 'Pru',
'Publia',
...
'Squier', 'Stamata', 'Stanhope', 'Stanway',
'Steffi',
'Stent', 'Steven', 'Stolzer', 'Strickler',
'Stronski',
'Studley', 'Sumer', 'Sung', 'Sven', 'Swagerty',
'Sylvia', 'Talbert', 'Tallbot', 'Tallulah',
'Tandy',
'Tannie', 'Tarr', 'Tarrel', 'Terrill', 'Terti',
'Tewfik', 'Thadeus', 'Thalassa', 'Thanos',
'Theadora',
'Theola', 'Theresa', 'Therine', 'Thilda', 'Thill',
'Thirion', 'Thorwald', 'Thurmann', 'Tibbetts',
'Tien',
'Tiffi', 'Tolmann', 'Tomlinson', 'Tonneson',
'Torrance',
'Torrence', 'Trask', 'Tremaine', 'Trip', 'Trish',
'Tristram', 'Trojan', 'Truitt', 'Tseng', 'Tulley',
'Turrell', 'Tut', 'Tutto', 'Uela', 'Ulphiah',
'Uriisa', 'Uttasta', 'Valaree', 'Valentin',
'Valley',
...
'Winwaloe', 'Witcher', 'Woodley', 'Woodman',
'Wrand',
'Wrennie', 'Wystand', 'Yelich', 'Yurik', 'Yves',
'Zamora', 'Zebapda', 'Zeiler', 'Zellner',
'Zucker');
...
BEGIN
RETURN trunc(sysdate - floor(dbms_random.value(7300, 25550))); -- Between
20 and 70 yrs ago
END;
...
NULL;
v_customer_id := ins_customer(prsn_name(), prsn_name(), prsn_name(),
bdate(), get_random_gender());
END LOOP;
